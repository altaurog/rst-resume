...
\definecolor{brbg74}{rgb}{0.91,0.91,0.91}
...
{}
{0pt}
{\raisebox{-0.365em}[0em][0em]{\color{brbg74} #1}}

\titlespacing{\section}{0pt}{-0.7em}{0pt}

\newcommand{\infosep}{\makebox[2em][c]{$\bullet$}}
\newcommand{\MYNAME}{{\Huge \sffamily \bfseries \color{brbg71}\@title}}
\newcommand{\MyName}{{\Large \sffamily \bfseries \color{brbg71}\@title}}
...
\renewcommand{\headrule}{\vspace{-7pt}\vbox to 0pt{%
  \hbox to\headwidth{%
    \color{brbg71}\leaders\hrule height \plainheadrulewidth\hfill}}}
