    ...
    {\pagebreak[1]\begin{list}{}%
        ...
        \ifthenelse{\value{descnesting} > 1}%
            ...
            {\renewcommand{\makelabel}[1]{\raisebox{0pt}[\baselineskip][0pt]%
                {\parbox[t]{\mylcolwidth - 0.65em}{\raggedright\sffamily \bfseries ##1}\hfil}}%
...
\renewenvironment{itemize}
    ...
    {\end{list}\vspace{.7\baselineskip}}
...
\newcommand{\MYINFO}{{\sffamily \@infoemail}}
\newcommand{\MyInfo}{\MYINFO}
\makeatother
